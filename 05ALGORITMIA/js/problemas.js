...
function problema3(){
    ...
    for (var i = 0; i < palabrasSeparadas.length; i++) {
        ...
        if (caracteresUnicos > maxCaracteresUnicos) {
            ...
            caracteresUnicosPalabra = obtenerCaracteresUnicos(palabra);
        }
    }
    // for( var i=0;palabraConMasCaracteresUnicos.length;i++){

        document.querySelector('#p3-output').textContent = "La palabra " + palabraConMasCaracteresUnicos.toString() + " tiene " + maxCaracteresUnicos + " caracteres únicos. Los caracteres únicos son: " + caracteresUnicosPalabra.join(", ");
    // }
}
...
function obtenerCaracteresUnicos(palabra) {
